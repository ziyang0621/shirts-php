	...
	<div class="header">
		...
		<div class="wrapper">
			...
			<ul class="nav">
				...
				<li class="contact <?php if ($section =="search") { echo "on"; } ?>"><a href="<?php echo BASE_URL; ?>search/">Search</a></li>
				<li class="cart"><a target="paypal" href="https://www.paypal.com/cgi-bin/webscr?cmd=_cart&amp;business=4ZN9BNQWJV8FL&amp;display=1">
Shopping Cart</a></li>
			</ul>
